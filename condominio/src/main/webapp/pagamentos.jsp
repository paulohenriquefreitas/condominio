				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-edit"></i> Pagamentos</li>
						</ol>
					</div>
				</div>
				<div class="row">
						...
						<form action="/pagamento/save">
							<div class="form-group">
								...
								<label class="control-label" for="date">Data</label> <input
									class="form-control" id="date" name="data"
							...
							<div class="form-group">
								<label>Valor</label> <input id="valor" name="valor"
										...
										<tr>
											...
											<td>
												<p data-placement="top" title="Edit">
													<button class="open-pagamento btn btn-primary btn-xs"
														...
														data-valor="${pagamento.valor}" data-target="#edit">
														<span class="glyphicon glyphicon-pencil"></span>
													</button>
												</p>
												<p data-placement="top" title="Delete">
													<button class=" delete-pagamento btn btn-danger btn-xs"
					...
					<form class="form-horizontal" role="form" method="post"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="form-group">
									<input class="form-control " name="id_pagamento"
										id="id_pagamento" readonly>
								</div>
								<div class="form-group">
