...
<!DOCTYPE html>
<html xmlns:h="http://java.sun.com/jsf/html" lang="en">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-edit"></i> Cadastro - Moradores</li>
						</ol>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4">
						...
						<form action="/morador/save">
							...
							<div class="form-group">
								<label>Nome do morador ou proprietário</label> <input id="nome"
									name="nome" class="form-control" placeholder="Enter text">
							</div>
							<div class="form-group">
								<label>Apartamento</label> <select name="ap"
									class="form-control">
